...
class CollectionConfig(BaseModel):
    ...
    caption_shot_mapping_file: Optional[str] = Field(None, description="Path to caption shot mapping")
    segment_duration: Optional[float] = Field(None, description="Segment duration for captions")
    ...
    pca_embeddings_file: Optional[str] = Field(None, description="Path to PCA embeddings")
    ...
    @validator('caption_index', 'pca_model', 'std_scaler', 'pca_embeddings_file', 'embeddings_file')
...
class LSEConfig(BaseModel):
    ...
    collection_configs: Dict[str, CollectionConfig] = Field(..., description="Per-collection configurations")
        ...
        try:
            ...
            for collection_name in collections:
                if collection_name not in parser:
                    raise ConfigurationError(f"Collection '{collection_name}' not found in config")
